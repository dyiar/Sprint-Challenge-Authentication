...
Sessions give us a way to persist data across requests on the server so the client doesn't need to keep re-entering their credentials.

1. What does bcrypt do to help us store passwords in a secure manner.

It hashes passwords, implements salting for us automatically, and has accumulative hasing rounds.

1. What does bcrypt do to slow down attackers?

It adds time to our hash, giving us a key derivation function.

1. What are the three parts of the JSON Web Token?

The header, the payload, and the string.
